 ...
 */
public class Heap<Value> implements HeapInterface<Value>, Serializable {
    //region Fields
    ...
    @Override
    public Value getContent(Integer address) throws InterpretorException {
        try{
            return heap.get(address);
        } catch (Exception e){
            throw new InterpretorException("Can't get inexistent value");
        }
    }
