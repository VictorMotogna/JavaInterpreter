...
//                                continue;
//                            mainStatement = new AssignmentStatement(name, assignExpression);
//                            done = true;
//                        } catch (Exception e) {
//                            System.out.print(e + "\n");
//                        }
...
//            switch (option) {
//                case 1:
//                    ExecutionStackInterface<Statement> executionStack= new ExecutionStack<Statement>();
//                    SymbolsTableInterface<String, Integer> symbolsTable = new SymbolsTable<String, Integer>();
//                    OutputInterface<Integer> output = new Output<Integer>();
